...
import decryption.DefaultDecryptionServiceImpl;
...
public class DataProcessor {
    ...
    private DataProcessor(ConnectionFactory connectionFactory, RequestParams requestParams) {
        ...
        this.connection = connectionFactory.getConnection(requestParams.getCassandraHost(), requestParams.getCassandraKeyspaceName(), requestParams.getCassandraPort());
        this.decryptionService = new DefaultDecryptionServiceImpl(requestParams.getSunbirdEncryptionKey());
    }
     ...
     * @return
     */
    public static DataProcessor getInstance(ConnectionFactory connectionFactory, RequestParams requestParams) {
    ...
    public void startProcessingExternalIds() {
        ...
        usersList.stream().forEach(userObject -> {
