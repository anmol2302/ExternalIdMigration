...
public class HttpClient {
    ...
    public String generateAuthToken(String userName) {
        try {
            ...
            String url=parms.getBaseUrl().concat("/auth/realms/").concat(parms.getRealm()).concat("/protocol/openid-connect/token");
            if (StringUtils.isNotBlank(userName) && StringUtils.isNotBlank(url)) {
                ...
                logger.info("HttpClient:post: statusCode = " + response.getStatusLine().getStatusCode());
                Map<String,Object> tokenMap= mapper.readValue(response.getEntity().getContent(),
